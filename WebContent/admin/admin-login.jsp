		...
		<div class="row">
			<div
				...
				<h1 class="brand brand-big align-center">
					<a href="index.html"> <img src="../image/logo-big.png"><br>
					</a>
				</h1>
			</div>
		</div>
									...
									<div class="panel-body">
										<form method="post" action="admin_login.action"
											...
											<div class="form-group">
												<div class="col-xs-12">
													<div class="input-group">
														<span class="input-group-addon"><i
															...
															class="form-control input-lg" placeholder="密码"> <span
												...
												<span class="input-group-addon"> <s:property
																value="errinfo" /></span>
											</div>
