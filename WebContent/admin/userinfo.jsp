						...
						<div id="content">
							...
							<font color="red"><s:property value="errinfo"/></font>
								<form id="defaultForm" method="post" class="form-vertical"
									action="admin_saveUserinfo.action"
									...
									<div class="form-group">
										<label><h3 class="grey">用户名</h3></label> <input type="text"
											...
											placeholder="用户名" value="<s:property value='user.username'/>"><span
									...
									<div class="form-group">
										<label><h3 class="grey">密码</h3></label> <input type="text"
											...
											value="<s:property value='user.password'/>"> <span
									...
									<div class="form-group">
										<label><h3 class="grey">性别</h3></label> <select name="gender"
											...
											<option value="0" <s:if test="user.gender==0">selected</s:if>>男</option>
											<option value="1" <s:if test="user.gender==1">selected</s:if>>女</option>
									...
									<div class="form-group">
										<label><h3 class="grey">状态</h3></label> <select name="state"
											class="form-control" id="corp-big">
											<option value="">请选择</option>
											<option value="0" <s:if test="user.state==0">selected</s:if>>正常</option>
											<option value="1" <s:if test="user.state==1">selected</s:if>>屏蔽</option>
									...
									<div class="form-group">
										<label><h3 class="grey">权限</h3></label> <select
											...
											<option value="">请选择</option>
											<option value="0"
												<s:if test="user.permission==0">selected</s:if>>管理员</option>
											<option value="1"
												<s:if test="user.permission==1">selected</s:if>>普通用户</option>
...
<!-- 									<div class="form-group"> -->
<!-- 										<label><h3 class="grey">备注</h3></label> <input type="text" -->
<!-- 											id="description" name="description" class="form-control" -->
<!-- 											placeholder="请输入备注说明" -->
<%-- 											value="<s:property value='user.description'/>"> <span --%>
